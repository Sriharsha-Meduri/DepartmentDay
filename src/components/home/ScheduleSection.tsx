...
const SCHEDULE = [
  ...
  {
    date: 'Mar 15-16',
    fullDate: 'Sunday 9:00 AM to Monday 9:00 AM',
    time: 'Sun 9:00 AM - Mon 9:00 AM',
    title: 'Vibeathon',
    description: '24-hour web build sprint. PS drops Sunday at 9:00 AM and submissions close Monday at 9:00 AM. Team size: up to 4 members.',
    venue: 'IT Department',
    emoji: '🎨',
    color: 'bg-purple-500',
  },
